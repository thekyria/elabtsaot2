...
//CalibrationXMLHandler::CalibrationXMLHandler(CalibrationEditor* cal ){
//    cal->_hard_reset();
//}

//// Implementation of virtual functions
//bool CalibrationXMLHandler::characters(QString const& ch){
...
//        if (_tags.last()=="Name")
//          cout << value << endl;
//        if (_tags.last()=="Devicenumber")
//          cout << value << " Devices discovered in XML file" << endl;
//  }

//  // Find which attribute is set
//  // --------------- Bus ---------------
//  if (_tags.contains("Devices")){
//      if (_tags.contains("Device")){
//          if (_tags.contains("Id")){
//              cout << "Importing dev with id" << value << endl;
//          }
//          if (_tags.contains("Name")){
//              cout << "Importing dev with name" << value << endl;
//          }
//          if (_tags.contains("Nodes")){
//              if (_tags.contains("Node")){
//                  if (_tags.contains("Id")){
//                  }
//                  if (_tags.contains("Data")){
//                      if (_tags.contains("Real")){
//                          if (_tags.contains("Name")){
//                          }
//                          if (_tags.contains("Offset")){
//                          }
//                          if (_tags.contains("Gain")){
//                          }
//                          if (_tags.contains("rab")){
//                          }
//                          if (_tags.contains("rw")){
//                          }
//                      }
//                      if (_tags.contains("Imag")){
//                          if (_tags.contains("Name")){
//                          }
//                          if (_tags.contains("Offset")){
//                          }
...
//bool CalibrationXMLHandler::startElement(QString const& namespaceURI,
...
//bool CalibrationXMLHandler::endElement(QString const& namespaceURI,
//                                       QString const& localName,
//                                       QString const& qName){
...
//void CalibrationXMLHandler::_resetState(){ // Reset handler to its first stage
//  if( _p_bus ){
//    delete _p_bus;
//    _p_bus = 0;
//  }
