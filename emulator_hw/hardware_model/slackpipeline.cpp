...
SlackPipeline::SlackPipeline(size_t element_capacity,
                             size_t ver_dim, size_t hor_dim) :
  Pipeline(element_capacity, ver_dim, hor_dim){}

void SlackPipeline::reset(){
...
int SlackPipeline::insert_element(size_t ver_pos, size_t hor_pos, Bus const& el, bool overwrite){
...
int SlackPipeline::remove_element(size_t ver_pos, size_t hor_pos){
  size_t k = 0;
  bool el_found = false;
