...
TDConstILoadPipeline::TDConstILoadPipeline(size_t element_capacity,
                                       size_t ver_dim, size_t hor_dim) :
    Pipeline(element_capacity, ver_dim, hor_dim),
    Iconst(_elementCountMax, 0) {}

void TDConstILoadPipeline::reset(){
...
int TDConstILoadPipeline::insert_element( size_t ver_pos, size_t hor_pos,
...
int TDConstILoadPipeline::remove_element(size_t ver_pos, size_t hor_pos){
