...
PQPipeline::PQPipeline(size_t element_capacity, size_t ver_dim, size_t hor_dim) :
  Pipeline(element_capacity, ver_dim, hor_dim),
  Sset(_elementCountMax, 0),
  I0(_elementCountMax, 0) {}

void PQPipeline::reset(){
...
int PQPipeline::insert_element(size_t ver_pos, size_t hor_pos, Bus const& el, bool overwrite){
  // pipeline is full!
...
int PQPipeline::remove_element(size_t ver_pos, size_t hor_pos){
  size_t k = 0;
  bool el_found = false;
