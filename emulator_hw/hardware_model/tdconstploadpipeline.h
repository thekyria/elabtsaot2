/*!
\file tdconstploadpipeline.h
\brief Definition file for class TDConstPLoadPipeline
...
#ifndef TDCONSTPLOADPIPELINE_H
#define TDCONSTPLOADPIPELINE_H
...
/*!
  ...
  \date June 2011
*/
class TDConstPLoadPipeline : public Pipeline {
 ...
 public:
  ...
  /*! \param element_capacity Capacity of the pipeline; default MAXPLOADS
      ...
      \param hor_dim Horizontal dimension of the emulator the pipeline is
                     instantiated for */
  TDConstPLoadPipeline(size_t element_capacity, size_t ver_dim, size_t hor_dim);
  virtual ~TDConstPLoadPipeline(){}
