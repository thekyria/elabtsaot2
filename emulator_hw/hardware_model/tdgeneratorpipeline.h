/*!
\file tdgeneratorpipeline.h
\brief Definition file for class TDGeneratorPipeline
...
#ifndef TDGENERATORPIPELINE_H
#define TDGENERATORPIPELINE_H
...
/*! Class for the generator calculation pipelines of the digital part
  ...
  \author thekyria
  \date June 2011 */
class TDGeneratorPipeline : public Pipeline{
 ...
 public:
  ...
  /*! \param element_capacity Capacity of the pipeline
      ...
      \param hor_dim Horizontal dimension of the emulator the pipeline is
                     instantiated for */
  TDGeneratorPipeline(size_t element_capacity, size_t ver_dim, size_t hor_dim);
  virtual ~TDGeneratorPipeline(){}
