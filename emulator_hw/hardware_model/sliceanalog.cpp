...
void SliceAnalog::buildBrStatus(vector<int>& brStatus, bool real) const{
  ...
  // --- Node 1 ---
  atom = &_atomSet[0][0];
  brStatus((1-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((1-1)*6+4) = atom->embr(EMBRPOS_D,real).pot_near_sw()|atom->embr(EMBRPOS_D,real).pot_far_sw()?1:0;
  ...
  // --- Node 2 ---
  atom = &_atomSet[0][1];
  brStatus((2-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((2-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 3 ---
  atom = &_atomSet[0][2];
  brStatus((3-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((3-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 4 ---
  atom = &_atomSet[0][3];
  brStatus((4-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((4-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 5 ---
  atom = &_atomSet[0][4];
  brStatus((5-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((5-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 6 ---
  atom = &_atomSet[0][5];
  brStatus((6-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((6-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 7 ---
  atom = &_atomSet[1][0];
  brStatus((7-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((7-1)*6+4) = atom->embr(EMBRPOS_D,real).pot_near_sw()|atom->embr(EMBRPOS_D,real).pot_far_sw()?1:0;
  ...
  // --- Node 8 ---
  atom = &_atomSet[1][1];
  brStatus((8-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((8-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 9 ---
  atom = &_atomSet[1][2];
  brStatus((9-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((9-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 10 ---
  atom = &_atomSet[1][3];
  brStatus((10-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((10-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 11 ---
  atom = &_atomSet[1][4];
  brStatus((11-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((11-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 12 ---
  atom = &_atomSet[1][5];
  brStatus((12-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((12-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 13 ---
  atom = &_atomSet[2][0];
  brStatus((13-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((13-1)*6+4) = atom->embr(EMBRPOS_D,real).pot_near_sw()|atom->embr(EMBRPOS_D,real).pot_far_sw()?1:0;
  ...
  // --- Node 14 ---
  atom = &_atomSet[2][1];
  brStatus((14-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((14-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 15 ---
  atom = &_atomSet[2][2];
  brStatus((15-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((15-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 16 ---
  atom = &_atomSet[2][3];
  brStatus((16-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((16-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 17 ---
  atom = &_atomSet[2][4];
  brStatus((17-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((17-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 18 ---
  atom = &_atomSet[2][5];
  brStatus((18-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((18-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 19 ---
  atom = &_atomSet[3][0];
  brStatus((19-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((19-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 20 ---
  atom = &_atomSet[3][1];
  brStatus((20-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((20-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 21 ---
  atom = &_atomSet[3][2];
  brStatus((21-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((21-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 22 ---
  atom = &_atomSet[3][3];
  brStatus((22-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((22-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 23 ---
  atom = &_atomSet[3][4];
  brStatus((23-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
//  brStatus((23-1)*6+5) = atom->embr(EMBRPOS_L,real).pot_near_sw()|atom->embr(EMBRPOS_L,real).pot_far_sw()?1:0;
  ...
  // --- Node 24 ---
  atom = &_atomSet[3][5];
  brStatus((24-1)*6+0) = atom->node.pot_resistance_sw(real) & (real?atom->node.real_sw_resistance:atom->node.imag_sw_resistance) ? 1 : 0;
...
int SliceAnalog::nodeCurrentSource(size_t id_ver, size_t id_hor, double seriesR, double shuntR){
  ...
  _atomSet[id_ver][id_hor].node.real_sw_current = true;
  _atomSet[id_ver][id_hor].node.imag_sw_current = true;
  ...
  _atomSet[id_ver][id_hor].node.real_sw_voltage = false;
  _atomSet[id_ver][id_hor].node.imag_sw_voltage = false;
  _atomSet[id_ver][id_hor].node.real_sw_current_shunt = false;
  _atomSet[id_ver][id_hor].node.imag_sw_current_shunt = false;

  // Connect resistance to ground - if needed
  if (shuntR > 0){
    // Close the resistance to ground switch
    _atomSet[id_ver][id_hor].node.real_sw_resistance = true;
    _atomSet[id_ver][id_hor].node.imag_sw_resistance = true;
    ...
    _atomSet[id_ver][id_hor].node.real_sw_resistance = false;
    _atomSet[id_ver][id_hor].node.imag_sw_resistance = false;
...
int SliceAnalog::nodeVoltageSource(size_t id_ver, size_t id_hor, double shuntR){
  ...
  _atomSet[id_ver][id_hor].node.real_sw_voltage = true;
  _atomSet[id_ver][id_hor].node.imag_sw_voltage = true;

  // Disconnect current source and open internal potentiometer switch
  _atomSet[id_ver][id_hor].node.real_sw_current = false;
  _atomSet[id_ver][id_hor].node.imag_sw_current = false;
