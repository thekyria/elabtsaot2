...
void TDGeneratorPipeline::reset(){
...
int TDGeneratorPipeline::insert_element(size_t ver_pos, size_t hor_pos,
...
int TDGeneratorPipeline::remove_element(size_t ver_pos, size_t hor_pos){
